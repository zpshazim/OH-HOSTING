// src/icons/DiscordLogo.tsx
const DiscordLogo = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 256 199"
    // className memungkinkan kita mengatur ukuran dan warna dari luar
    className={className}
  >
    <path
      // Menggunakan "currentColor" agar warnanya bisa diatur oleh text-color di Tailwind
      fill="currentColor"
